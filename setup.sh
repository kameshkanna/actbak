...
echo "  python experiments/02_direction_extraction.py"
echo "  python experiments/03_ramp_steering_eval.py"
echo ""
echo "  # Run ablations:"
echo "  python ablations/01_norm_calibration.py"
echo "  python ablations/02_reconstruction_capacity.py"
